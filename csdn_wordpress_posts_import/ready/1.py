...
# # res = Crawl_helper_tools_url.http_auth_handle_get_tag(wp_url_tags,wp_data)
# print res
# sys.exit()
...
url = 'http://blog.csdn.net/w_yunlong/'
...
while(i <= int(page)):
    ...
    try:
        ...
        print 'except read some page error....'+next_page_url,e
        sys.exit()
